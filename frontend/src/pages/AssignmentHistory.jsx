...
import { Card, List, Tag, Button, Spin, message, Empty, Statistic, Row, Col } from 'antd'
import {
    ArrowLeftOutlined,
    TrophyOutlined,
    ClockCircleOutlined,
            ...
            <Card title={
                <div style={{marginTop:20}}>
                    ...
                    <div style={{ fontSize: 13, color: '#999', marginTop: 4 }}>
                        ...
                        Hạn nộp: {new Date(assignment.dueDate * 1000).toLocaleString('vi-VN')}
                    </div>
                </div>
                                    ...
                                    description={
                                        <div>
                                            ...
                                            <div style={{ fontSize: 13, color: '#999' }}>
                                                Nộp lúc: {new Date(submission.submittedAt * 1000).toLocaleString('vi-VN')} |
