...
-- Make sure you have:
-- - User ID 1 (admin - teacher)
-- - User IDs 2-6 (students: hs5a01, hs5a02, hs5a03, hs5b01, hs5b02)
...
-- Assign Assignment 1 to students in class 5A (hs5a01, hs5a02, hs5a03)
-- Note: Giả sử student IDs là 2, 3, 4
...
-- Assign Assignment 3 to class 5B only
INSERT INTO assignment_students (assignmentId, studentId) VALUES
  (3, 5), -- hs5b01
  (3, 6); -- hs5b02
