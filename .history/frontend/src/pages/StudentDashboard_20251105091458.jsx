  ...
  return (
    <div className="student-dashboard">
      ...
      <style>{`
        ...
        .student-dashboard .ant-list-item-action > li {
          padding: 0;
        }

        .student-dashboard .ant-btn {
          white-space: nowrap;
        }

        .student-dashboard .ant-tag {
          white-space: nowrap;
          margin: 0 0 0 8px;
        }
        ...
        * {
        ...
        .student-dashboard .ant-row,
        .student-dashboard .ant-col,
        .student-dashboard .ant-input,
        .student-dashboard .ant-select {
          flex-shrink: 0;
        }

        /* Ngăn chặn tất cả các component con mở rộng */
        .student-dashboard .ant-select-dropdown {
          min-width: fit-content !important;
        }

        .student-dashboard .ant-select-item {
          white-space: nowrap;
        }
